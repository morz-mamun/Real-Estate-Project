...
const WishCart = ({ property, refetch }) => {
    ...
    <div className="card bg-slate-200 col-span-1 cursor-pointer group">
      <div className="flex flex-col gap-2 w-full">
        ...
        <div className="flex justify-between items-center gap-1 p-2">
          <div className="font-semibold text-sm">Price Range: ${price}</div>
          <div className="font-bold text-green-600">{status}</div>
        </div>
        <div className="flex justify-center gap-1 md:gap-5 pb-4">
          <Link to={`/dashboard/makeOffer/${user?.email}/${_id}`}>
